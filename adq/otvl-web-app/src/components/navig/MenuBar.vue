          ...
          <div class="flex items-center">
            ...
            <div class="block md:hidden">
              <div class="v-menu-container">
                ...
                <router-link to="/"><img class="ml-4 rounded-full py-1 h-12" src="/adq_brand_logo.jpg"></router-link>
                <router-link class=v-menu-bar-item-link to="/">Ateliers du QI</router-link>
              </div>
            </div>

            <div class="hidden md:block">
              <div class="v-menu-container">
                <router-link to="/"><img class=ml-4 src="/adq_brand_logo.jpg"></router-link>
